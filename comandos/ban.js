...
module.exports.executar = async (sock, msg) => {
    ...
    try {
        ...
        await sock.groupParticipantsUpdate(jid, [alvo.id], "remove");
        ...
        console.error("ERRO BAN:", erro);

        await sock.sendMessage(jid, {
            text: "❌ Não consegui banir. Confere se o bot é admin e se a pessoa não é admin/dono do grupo."
        });
    }
};